...
if __name__ == '__main__':
    # TestRule1 code
    print("cryptography -> AESECB_example7_indirect_g_variable_access:",
          decrypt_aes_ecb(g_key, p_example7_indirect_g_variable_access(g_key, g_plaintext)) == g_plaintext)
