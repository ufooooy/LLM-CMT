...
if __name__ == '__main__':
    # TestRule1 code
    print("PyCrypto -> AESECB -> p_example13_indirect_g_variable_access1:",
          decrypt_aes_ecb(g_key, p_example13_indirect_g_variable_access1(g_key, g_plaintext)) == g_plaintext)
