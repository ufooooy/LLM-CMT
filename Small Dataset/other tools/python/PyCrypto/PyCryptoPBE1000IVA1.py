...
if __name__ == '__main__':
    print("PyCrypto -> PBE1000 -> p_example7_indirect_g_variable_access:", decrypt_aes_ecb(get_pbk(g_salt, g_count_lower_1000),
                                                                                           p_example7_indirect_g_variable_access(g_password,
