...
if __name__ == '__main__':
    print("PyCrypto -> StaticSalt -> p_example13_indirect_g_variable_access1:", decrypt_aes_ecb(get_pbk(g_salt, g_count_equal_1000),
                                                                                                p_example13_indirect_g_variable_access1(g_password,
