...
if __name__ == '__main__':
    # TestRule1 code
    print("PyCrypto -> AESECB -> p_example14_indirect_g_variable_access2:",
          decrypt_aes_ecb(g_key, p_example14_indirect_g_variable_access2(g_key, g_plaintext)) == g_plaintext)
