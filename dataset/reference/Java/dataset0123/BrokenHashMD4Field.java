...
public class BrokenHashMD4Field {
    CryptoHash3 crypto;
    public BrokenHashMD4Field() throws NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException, UnsupportedEncodingException {
