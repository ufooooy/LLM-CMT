...
if __name__ == '__main__':
    print("cryptography -> AESCBC -> p_example14_indirect_g_variable_access2:",
          decrypt_aes_cbc(g_key, g_iv, p_example14_indirect_g_variable_access2(g_key, g_plaintext)) == g_plaintext)
