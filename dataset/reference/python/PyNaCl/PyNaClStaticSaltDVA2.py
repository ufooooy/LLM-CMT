...
if __name__ == '__main__':
    print("PyNaCl -> StaticSalt -> p_example12_direct_g_variable_access2:",
          decrypt(get_pbk(g_salt), p_example12_direct_g_variable_access2(g_password, g_plaintext)[24:]) == g_plaintext)
