...
def p_example11_direct_g_variable_access1(data):
    cipher = AES.new(g_key1, AES.MODE_ECB)
...
if __name__ == '__main__':
    print("PyCrypto -> Key -> p_example11_direct_g_variable_access1:",
          decrypt_aes_ecb(g_key, p_example11_direct_g_variable_access1(g_plaintext)) == g_plaintext)
