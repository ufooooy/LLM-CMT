...
if __name__ == '__main__':
    print("PyNaCl -> StaticSalt -> p_example13_indirect_g_variable_access1:",
          decrypt(get_pbk(g_salt), p_example13_indirect_g_variable_access1(g_password, g_plaintext)[24:]) == g_plaintext)
