...
if __name__ == '__main__':
    print("cryptography -> AESCBC -> p_example11_direct_g_variable_access1:",
          decrypt_aes_cbc(g_key, g_iv, p_example11_direct_g_variable_access1(g_key, g_plaintext)) == g_plaintext)
