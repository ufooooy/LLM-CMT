...
if __name__ == '__main__':
    print("PyCrypto -> StaticSalt -> p_example12_direct_g_variable_access2:", decrypt_aes_ecb(get_pbk(g_salt, g_count_equal_1000),
                                                                                              p_example12_direct_g_variable_access2(g_password,
