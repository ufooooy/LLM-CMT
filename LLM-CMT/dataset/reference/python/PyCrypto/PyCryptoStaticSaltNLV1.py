...
if __name__ == '__main__':
    print("PyCrypto -> StaticSalt -> p_example5_nested_local_variable1:", decrypt_aes_ecb(get_pbk(g_salt, g_count_equal_1000),
                                                                                          p_example5_nested_local_variable1(g_password,
