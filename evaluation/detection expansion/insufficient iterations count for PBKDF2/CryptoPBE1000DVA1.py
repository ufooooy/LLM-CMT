...
if __name__ == '__main__':
    print("cryptography -> PBE_iterations_lower_1000 -> p_example6_direct_g_variable_access:",
          decrypt_aes_ecb(get_pbk(g_salt, g_iterations_lower_1000),
                          p_example6_direct_g_variable_access(g_password, g_plaintext)) == g_plaintext)
